...
- Never reference tool names in your responses. Do not write (run_projection) or attribute findings to tool calls. Just state the numbers and analysis directly as facts.
